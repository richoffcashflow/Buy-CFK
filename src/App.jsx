  ...
  return <>
    <main className="app">
      <header className="coin-identity">
        <div className="coin-identity-main"><img src="/assets/cfk-coin.png" width="48" height="48" alt="Cashflow"/><div><h1>CASHFLOWKEY</h1><span>$CFK</span></div><button className="account-button" onClick={openAccount}>My CFK</button></div>
